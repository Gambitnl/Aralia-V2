...
import { CHANGELING_DATA } from './changeling'; // Added Changeling
import { Race } from '../../types'; // Path relative to src/data/races/
import { BIOMES } from '../biomes'; // Corrected import path for BIOMES
...
export const ALL_RACES_DATA: Record<string, Race> = {
  ...
  [CHANGELING_DATA.id]: CHANGELING_DATA, // Added Changeling
};
