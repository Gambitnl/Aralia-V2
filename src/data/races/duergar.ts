...
export const DUERGAR_DATA: Race = {
  ...
  abilityBonuses: [], // "When determining your character’s ability scores, increase one score by 2 and increase a different score by 1, or increase three different scores by 1." - Handled by Point Buy.
  traits: [
    'Creature Type: Humanoid. You are also considered a dwarf for any prerequisite or effect that requires you to be a dwarf.',
    'Size: Medium',
    'Speed: 30 feet',
    'Darkvision: 120 feet. You can see in dim light within 120 feet of you as if it were bright light and in darkness as if it were dim light. You discern colors in that darkness only as shades of gray.',
    ...
    'Languages: Common and one other language (typically Dwarvish or Undercommon - player choice).',
  ],
};
