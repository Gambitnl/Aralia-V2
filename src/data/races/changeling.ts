...
export const CHANGELING_DATA: Race = {
  ...
  traits: [
    'Creature Type: Fey',
    'Size: Medium or Small. You choose the size when you select this race.', // Defaulted to Medium for now
    'Speed: 30 feet',
    'Changeling Instincts: Thanks to your connection to the fey realm, you gain proficiency with two of the following skills of your choice: Deception, Insight, Intimidation, Performance, or Persuasion. (Chosen during character creation).',
    ...
    'Languages: Common and one other language appropriate for the character (typically Sylvan or one common in their adopted personas).',
  ],
};