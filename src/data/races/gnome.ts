 ...
 * This includes base Gnome traits and specific Gnome Subraces: Forest Gnome, Rock Gnome, and Deep Gnome.
 */
...
const GNOME_SUBRACES_DATA: GnomeSubrace[] = [
  {
    ...
    traits: [
      'Ability Score Increase: When determining your character’s ability scores, increase one score by 2 and increase a different score by 1, or increase three different scores by 1. (Descriptive; not mechanically implemented as fixed bonuses).',
  ...
  },
  {
    ...
    description:
      'As a deep gnome, you have traits suited to survival in the Underdark. Also called svirfneblin, deep gnomes live in the deep underground. They are insular, cautious, and wary of outsiders.',
    traits: [
      'Ability Score Increase: When determining your character’s ability scores, increase one score by 2 and increase a different score by 1, or increase three different scores by 1. (Descriptive; not mechanically implemented as fixed bonuses).',
      'Superior Darkvision: Your Darkvision has a radius of 120 feet.',
      'Stone Camouflage: You have advantage on Dexterity (Stealth) checks made to hide in rocky terrain. (Trait for flavor/future mechanics).',
      'Deep Gnome Magic: You learn the Nondetection spell. You can cast this spell a number of times equal to your proficiency bonus per long rest. Your spellcasting ability for this spell will be chosen during character creation.',
    ],
    grantedSpell: {
      id: 'nondetection',
      spellcastingAbilitySource: 'subrace_choice',
...
export const GNOME_DATA: Race = {
  ...
  traits: [
    ...
    'Gnome Subrace: Choose a Forest, Rock, or Deep Gnome subrace, granting specific benefits.',
  ],
