...
}> = ({ action, onClick, disabled, className = '', isGeminiAction = false, badgeCount }) => {
  const baseClasses = "font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-150 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-opacity-75 relative"; // Added relative for badge positioning
